...
solar_minima_spot_num_dist = np.round(np.load('solar_minima_spot_num_dist.npy'))
...
results = make_observations_parallel(n_rotations = 12*300, 
                            num_spots = solar_minima_spot_num_dist,
...
name = f'all_minima_obs_phi_{degs[run_index]}.json'
